...
cdef class Gini2(ClassificationCriterion):
    r"""Gini2 Index impurity criterion.
    ...
    cdef void children_impurity(self, double* impurity_left,
        ...
        for k in range(self.n_outputs):
            ...
            gini_left += 2.0 - sq_count_left / (self.weighted_n_left *
                                                self.weighted_n_left)

            gini_right += 2.0 - sq_count_right / (self.weighted_n_right *
                                                  self.weighted_n_right)
